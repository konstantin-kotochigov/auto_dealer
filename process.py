def main():
    ...
    print("CJ read rows = {}".format(cj.count()))
    ...
    # output_file = "/user/kkotochigov/bmw_cj_lstm.parquet"
    ...
    print("Processed Customer Rows = {}".format(y_py.shape[0]))
    ...
    print("Scored Data Shape = {}".format(result.shape[0]))
